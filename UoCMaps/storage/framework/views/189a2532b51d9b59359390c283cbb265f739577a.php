            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('nic') ? ' has-error' : ''); ?>">
                            <label for="nic" class="col-md-4 control-label">Nic Number</label>

                            <div class="col-md-6">
                                <input id="nic" type="text" class="form-control" name="nic" value="<?php echo e(old('nic')); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('job_title') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="job_title" type="text" class="form-control" name="job_title" value="<?php echo e(old('job_title')); ?>" required>
