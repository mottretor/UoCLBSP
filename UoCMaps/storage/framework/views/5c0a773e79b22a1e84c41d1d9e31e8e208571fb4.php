...
<div style="width: 100%; height: 90%; float: bottom">
  ...
  <div> 
    ...
    <?php echo Form::open(['url' => '/updatepeople','method' => 'post']); ?>
            ...
            <form action="/updatepeople" method="post">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="Latitudes" id="infoLat" value="<?php echo e($user->latitude); ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="Longitudes" id="infoLng" value="<?php echo e($user->longitude); ?>">
                ...
                <button type="button" class="btn btn-default"> <a href="/deletepeople/<?php echo e($user->nic); ?>">Delete</a></button>
