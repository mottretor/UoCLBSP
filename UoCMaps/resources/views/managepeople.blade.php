...
<div style="width: 100%; height: 90%; float: bottom">
  ...
  <div  style=" width: 300px">
    <form action="/peoplesearch" method="POST" role="search">
    {{ csrf_field() }}
    <div class="input-group">
        <input type="text" class="form-control" name="q"placeholder="Search People"> 
  ...
  <div>	
        ...
        <div class="btn-group" role="group" aria-label="...">
			<div class="btn-group" role="group" aria-label="...">
  		<button type="button" class="btn btn-default"> <a href="addpeople">Add People</a></button>
...
?>
    ...
    <script>
    var coords = {lat: 6.902215976621638, lng: 79.86069999999995};

    //alert(JSON.stringify(coordsObj));
    //alert(coordsObj[0]['lat'])
